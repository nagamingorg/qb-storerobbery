...
Config.Registers = {
  ...
  [35] = {vector3(1698.22, 4923.21, 42.06), robbed = false, time = 0, safeKey = 11},
  ...
  [59]= {vector3(1392.93, 3606.41, 34.98), robbed = false, time = 0, safeKey = nil},
}
